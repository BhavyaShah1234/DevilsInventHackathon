    ...
    <div className="min-h-screen p-4 md:p-8 relative bg-gradient-to-br from-black via-gray-900 to-gray-950 text-white">
      ...
      <main className="relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Logo Section */}
          <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700 flex justify-center items-center">
            <img
              src="/logo.png"
              alt="Logo"
        ...
        <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700 mt-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            <Link
              to="/inventory"
              className="bg-blue-900/30 hover:bg-blue-900/50 p-4 rounded-lg border border-blue-800 text-center transition-all"
            >
