  ...
  return (
    <div className="min-h-screen p-4 md:p-8 relative bg-gradient-to-br from-gray-100 via-gray-200 to-white text-black dark:from-black dark:via-gray-900 dark:to-gray-950 dark:text-white transition-colors">
      ...
      <main className="relative z-10">
        ...
        {/* Quick Navigation */}
        <div className="bg-white dark:bg-gray-800/50 p-4 rounded-lg border border-gray-300 dark:border-gray-700 mt-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div className="bg-gray-100 dark:bg-gray-800/50 p-4 rounded-lg border border-gray-300 dark:border-gray-700 text-center">
