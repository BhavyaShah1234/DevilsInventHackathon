          ...
          <div className="space-y-6">
            <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
              ...
              <div className="relative w-full max-w-[900px] h-[600px] border border-gray-600 rounded overflow-hidden mx-auto">
                ...
                {obstacles.map((obs, i) => (
                  <div key={i} className="absolute bg-red-500/30 border border-red-500" style={{ top: obs.y, left: obs.x, width: obs.width, height: obs.height }} />
                ))}
              ...
              <div className="mt-4 flex gap-4 justify-center">
                ...
                <button onClick={handleRunInventory} disabled={isEmergencyStopped} className={`px-4 py-2 rounded ${isEmergencyStopped ? 'bg-gray-600 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'} text-white`}>
                  ▶️ Start Robot
                </button>
                <button onClick={() => setIsRunningInventory(false)} className="bg-gray-700 hover:bg-gray-600 text-white px-4 py-2 rounded">
                  ⏸ Pause
                </button>
              </div>
              {isEmergencyStopped && (
              ...
              <div className="mt-6 flex justify-center">
                <button onClick={() => navigate('/inventory')} className="bg-yellow-600 hover:bg-yellow-700 text-white px-5 py-2 rounded shadow">
                  🔍 View Inspection
                </button>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
              <div className="flex justify-between items-center mb-4">
                ...
                <button onClick={handleStartCamera} className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded shadow">
                  🎥 Start Live Camera
                </button>
              </div>
